          ...
          <div className="flex items-start gap-6">
            ...
            <div className="flex-1">
              ...
              <div className="grid grid-cols-4 gap-6">
                <div>
                  <div className="text-3xl font-bold text-[#1A3C34]">{researcher.publications}</div>
                  <div className="text-sm text-gray-600">Publications</div>
                </div>
                <div>
                  <div className="text-3xl font-bold text-[#16a34a]">{researcher.citations}</div>
                  <div className="text-sm text-gray-600">Citations</div>
                </div>
                <div>
                  <div className="text-3xl font-bold text-[#1A3C34]">{researcher.hIndex}</div>
            ...
            {researcherPapers.length > 0 ? (
              researcherPapers.map(paper => (
                <div key={paper.id} className="border-b pb-4">
                  <h3 className="font-bold text-lg text-[#1A3C34] mb-2">{paper.title}</h3>
