          ...
          <div className="flex items-start gap-6">
            ...
            <div className="flex-1">
              ...
              <div className="grid grid-cols-4 gap-6">
                <div>
                  <div className="text-3xl font-bold text-blue-600">{researcher.publications}</div>
                ...
                <div>
                  <div className="text-3xl font-bold text-blue-600">{researcher.hIndex}</div>
            ...
            {researcherPapers.length > 0 ? (
              researcherPapers.map(paper => (
                <div key={paper.id} className="border-b pb-4">
                  <h3 className="font-bold text-lg text-blue-600 mb-2">{paper.title}</h3>
