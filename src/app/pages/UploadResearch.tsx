...
export function UploadResearch() {
  ...
  const { user, uploadResearch } = useApp();
  ...
  return (
    <ResearcherLayout>
      <div className="p-8 max-w-4xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl font-bold mb-2">Share new research</h1>
          <p className="text-gray-600">Upload your paper — AI will tag, classify, and find collaborators.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="flex gap-2 mt-2 mb-3">
                <Input
                  ...
                  placeholder="Add keywords (e.g., Machine Learning, Genomics)"
          ...
          <Card className="p-6 bg-[#1A3C34] text-white">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-bold text-lg mb-2">AI-Powered Publishing</h3>
                <p className="text-white/90 mb-3">
                  After you publish, our AI will automatically:
                </p>
                <ul className="space-y-1 text-sm text-white/90">
                  <li>✓ Extract and classify research topics</li>
                  <li>✓ Find researchers with complementary expertise</li>
                  <li>✓ Match with relevant funding opportunities</li>
                  <li>✓ Suggest potential collaborators (60-95% match scores)</li>
                  <li>✓ Add your work to trending topic analysis</li>
                </ul>
              </div>
            </div>
          </Card>
